...
const GatoChain = () => {
    ...
    return(
        ...
        <h5 className="sectionSubtitle">All the tools you need to start investing in total safety</h5>
        <div className="squareElementsGrid">
            <div className="squaresRow">
                <div className="darkSquare darkGreen">
                    ...
                    <p className="squareText">a key part of the GATO blockchain where it enables you to search for real-time and historical information about the blockchain.</p>
                ...
                <div className="darkSquare darkGreen">
                    ...
                    <p className="squareText">A one stop shop for decentralized trading on the GATO network, where users can exchange any GATO tokens.</p>
                    <h5 className="squareLearnMore">Learn More</h5>
            ...
            <div className="squaresRow">
                <div className="darkSquare darkGreen">
                    ...
                    <p className="squareText">Providing liquidity gives you a reward in the form of trading fees when people use your liquidity pool.</p>
                    <h5 className="squareLearnMore">Learn More</h5>
                ...
                <div className="darkSquare darkGreen">
                    ...
                    <p className="squareText">Staking allows GATO holders to earn extra income by contributing to the network security of a proof-of-stake (PoS).</p>
                    <h5 className="squareLearnMore">Learn More</h5>
