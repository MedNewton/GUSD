...
import Cone from '../animation3D/elements/cone';
import Box from '../animation3D/elements/box';
import Torus from '../animation3D/elements/taurus';
import { radians, map, distance, hexToRgbTreeJs } from '../animation3D/helpers';
...
export default class AnimationThree {
  setup() {
  ...
  addCameraControls() {
    this.controls = new new OrbitControls(this.camera, this.renderer.domElement);
  };
